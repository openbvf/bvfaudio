...
Transcription runs entirely on-device through Apple's Speech framework. The audio is fed to the recognizer from memory; no audio buffer is sent to any service.
